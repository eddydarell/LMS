namespace LMS_Grupp4.Migrations
{
   ...
   //		 //}
			...
			#region Files Init
			LMSFile file1 = new LMSFile
			{
				ID = 1,
				Name = "Lab picture",
				Format = "Picture",
				URL = "/testDirectory/testDirectory",
				IsPublicVisible = true,
				UploadDate = DateTime.Now,
				Size = 500.85,
				Uploader = studentUser,
				Assignment = assignment1,
				Courses = new List<Course>()
			};
			LMSFile file2 = new LMSFile
			{
				ID = 2,
   ...
   //		 //studentUser.ProgramClasses.Add(programClass1);
   //		 //studentUser.Courses.Add(course1);
			//studentUser.Assignments.Add(assignment1);
			//studentUser.Assignments.Add(assignment2);
			//studentUser.ClassSchemas.Add(classShema1);
			//studentUser.ClassSchemas.Add(classShema2);
			studentUser.Files.Add(file1);
			studentUser.Files.Add(file2);
			context.SaveChanges();
		}
	}
}
